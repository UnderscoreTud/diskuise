...
public class ExprDisguiseParticleType extends SimpleExpression<Particle> {
    ...
    static {
        Skript.registerExpression(ExprDisguiseParticleType.class, Particle.class, ExpressionType.PROPERTY,
                "[the] [potion[s]] particle[s] type [value] of (area [of effect]|AoE) [cloud] [dis(k|g)uise] %disguise%",
                "(area [of effect]|AoE) [cloud] [dis(k|g)uise] %disguise%'s [potion[s]] particle[s] type [value]");
    }

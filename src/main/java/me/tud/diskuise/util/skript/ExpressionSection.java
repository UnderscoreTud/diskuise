...
public abstract class ExpressionSection<T> extends Section implements Expression<T>, SyntaxElement {
    private int time = 0;

    protected ExpressionSection() {}

    protected static <E extends ExpressionSection<T>, T> void register(Class<E> c, Class<T> returnType, ExpressionType expressionType, String... patterns) {
        Skript.registerExpression(c, returnType, expressionType, patterns);
        Skript.registerSection(c, patterns);
    }
